    ...
    <main className='min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-8 px-4'>
      <div className='max-w-6xl mx-auto'>
        <div className='bg-white rounded-2xl shadow-xl p-8 md:p-12'>
          <div className='mb-8'>
            <h1 className='text-4xl font-bold text-slate-800 mb-2'>Update Listing</h1>
            <p className='text-slate-600'>Edit your property listing details below</p>
          </div>

          {success && (
            <div className='mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-center gap-3'>
              <FaCheckCircle className='text-green-600 text-xl' />
              <p className='text-green-800 font-medium'>Listing updated successfully! Redirecting...</p>
            </div>
          )}
